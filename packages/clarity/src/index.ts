...
server.registerTool(
  "clarity_get_insights",
  {
    ...
    description:
      "Get behavioral analytics (traffic, engagement, rage clicks, dead clicks, etc.) for the configured Clarity project, broken down by up to 3 dimensions. Only the last 1-3 days of data are available via this API, and the project has a small daily request quota — batch your dimension choices per call.",
    inputSchema: {
